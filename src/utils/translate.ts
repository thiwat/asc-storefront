...
let TRANSLATES: object = {
  ...
  parent_email: 'Email Address *Concert Tickets will be sent via this email, please check carefully',
  parent_email_th: 'อีเมล *บัตรเข้าชมการแสดงจะถูกส่งไปยังอีเมลที่ระบุ โปรดตรวจสอบความถูกต้อง',
  parent_phone_no: 'Phone Number',
  parent_phone_no_th: 'เบอร์โทรศัพท์',
